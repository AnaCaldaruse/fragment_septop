...
# SLURM_ARRAY_JOB_ID         Job array’s master job ID numbe:wqr.
...
declare -a DirectoryArray=("1" "2" "3")

for outer_dir in ${DirectoryArray[@]}; do
	for lambda_dir in ${outer_dir}/*/ ; do
		echo "22"|gmx trjconv -f ${lambda_dir}/NVT/nvt.gro -s ${lambda_dir}/Production_MD/prod.tpr -o ${lambda_dir}/Production_MD/new.gro 
		echo "0" |gmx trjconv -f ${lambda_dir}/Production_MD/prod.xtc -s ${lambda_dir}/Production_MD/new.gro -o ${lambda_dir}/Production_MD/traj.xtc -pbc mol
	done
done
