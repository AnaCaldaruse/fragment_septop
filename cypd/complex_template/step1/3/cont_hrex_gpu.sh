...
mpirun -np 12 gmx_mpi mdrun -ntomp 1 -nb gpu -cpi prod.cpt -append -deffnm prod -replex 200 -multidir $dir/lambda_{0..11}/Production_MD
#gmx mdrun -deffnm prod -ntomp 12 -ntmpi 1 -cpi prod.cpt -append
