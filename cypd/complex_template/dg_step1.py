    ...
    for r in repeats:
        try: 
            ...
            for time in timeslices:
                ...
                endpoint_diff = 0.596 * mbar.delta_f_.loc[[(0.00,0.00,0.00)], [(1.00,1.00,1.00)]]
                dg_diff = round(float(endpoint_diff.iloc[0][(1.00,1.00,1.00)]),3)
                dGs.append(dg_diff)
                uncertainty = 0.596 * mbar.d_delta_f_.loc[[(0.00,0.00,0.00)], [(1.00,1.00,1.00)]]
                uncertainty = round(float(uncertainty.iloc[0][(1.00,1.00,1.00)]),3)
            ...
            print(dGs)
            file = open('dg_%s_%i.pickle'%(p,r), 'wb')
            pickle.dump(dGs, file)
            file.close()
            file = open('dg_error_%s_%i.pickle'%(p,r), 'wb')
