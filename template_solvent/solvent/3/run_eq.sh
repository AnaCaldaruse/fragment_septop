...
gmx grompp -f $MDP/minimize.$LAMBDA.mdp -c $dir/../../solvent.gro -p $dir/../../solvent.top -o em.tpr -maxwarn 2

gmx mdrun -deffnm em -s em.tpr -nt 1 -ntmpi 1 
...
gmx grompp -f $MDP/equil_nvt.$LAMBDA.mdp -c ../EM/em.gro -p $dir/../../solvent.top -o nvt.tpr -maxwarn 2

gmx mdrun -deffnm nvt -s nvt.tpr -nt 1 -ntmpi 1

cd ../
mkdir Production_MD
cd Production_MD
gmx grompp -f $MDP/prod_md.$LAMBDA.mdp -c $dir/lambda_$LAMBDA/NVT/nvt.gro -p $dir/../../solvent.top -o prod.tpr -maxwarn 2
